...
define( "RECIPIENT_NAME", "Gabriella from Mama Buddies" );
define( "RECIPIENT_EMAIL", "mamabuddiesapp@gmail.com" );
...
// && $senderSubject && $senderPhone && $message (goes to IF statement)
